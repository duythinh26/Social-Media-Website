...
const Connections = () => {
    ...
    const dataArray = [
        ...
        { label: "Yêu cầu", value: pendingConnections, icon: UserRoundPen },
        { label: "Kết nối", value: connections, icon: UserPlus },
    ]
        ...
        <div className="min-h-screen bg-slate-50">
            <div className="max-w-6xl mx-auto p-6">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-slate-600">Quản lý và khám phá các kết nối mới</p>
                </div>
