                ...
                <div className='w-full pt-16 md:pt-0 md:pl-36'>
                    ...
                    <div className='flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-gray-500 mt-4'>
                        ...
                        <span className='flex items-center gap-1.5'>
                            ...
                            Tham gia <span className='font-medium'>{moment(user.createdAt).fromNow()}</span>
                        </span>
                    </div>

                    <div className='flex items-center gap-6 mt-6 border-t border-gray-200 pt-4'>
                        <div>
                            <span className='sm:text-normal font-bold text-gray-900'>{posts.length}</span>
                            <span className='text-xs sm:text-sm text-gray-500 ml-1.5'>bài đăng</span>
                        </div>
                        <div>
                            <span className='sm:text-normal font-bold text-gray-900'>
